...
4. Before drafting any chapter prose, load the required project files listed by `novel-writer`, especially `.ai/SUMMARY.md`, `02_PROJECT_DATABASE/00_CORE/02_plot.md`, the writing rules, style references, voice bible, and the latest relevant chapter text.
