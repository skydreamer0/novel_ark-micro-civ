...
graph TD
    ...
    LJ -->|交易關係：四成投放名冊 ↔ 中層政務窗口| ZZ
    ZZ -->|交易關係：數據與權限交換| LJ

    LJ -->|張力關係：信仰壟斷爭議| JI
    JI -->|潛在背叛：外部接觸未明| LJ

    AU -->|恐懼關係：撤銷自治權威脅 2/3同意| LJ
    LJ -->|恐懼關係：系統級病毒觀察| AU
...
- **第五卷新局勢提醒**：林燼從流亡反抗者升級為「灰鏈自治體領導人」，面臨的不再是直接追殺，而是制度性撤銷威脅與內部派系裂痕。祭司派的信仰壟斷張力、民生探針指向未明的中層接觸、祁闕代表的新型配額制度威脅，都應在章回中逐步展開，形成「看似有自治權實則被制度包圍」的困局。
...
| **技術位盟友：蘇嵐（駭客 / 後勤）** | 功能：駭入企業門禁、偽造假身分、抹除審計司追蹤訊號。人物弧：因巨額債務面臨人格重置，被主角救下後效忠。 | 掌握「轉化區稅流稽核 API」灰色後門，可即時改寫小隊信用評分與物流權限，是團隊能在系統內隱形行動的關鍵。             | 對記憶完整性有病態執著；一旦發現記憶遭竄改，會優先自保並切斷所有外部連線。 | 她弟弟仍在企業教育艙作為「優先培養樣本」，企業可用探視權與生命維持權綁架她。     | 主角相信「必要時可操弄真相」；蘇嵐堅持資料不可偽造到傷及無辜，拒絕無差別資訊戰。 | 若主角利用她的後門去製造大規模民生事故，或故意犧牲她弟弟換戰略優勢，她會把主角標記為最高威脅。 |
